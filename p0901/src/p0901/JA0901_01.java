...
public class JA0901_01 {
	...
	public static void main(String[] args) {
		...
		String name = "";  //문자열타입을 생성해서 빈 공백을 입력
		int kor = 0;       //국어점수를 입력 할 수 있는 변수선언
		int eng = 0;
		int math = 0;
		int total = 0; //합계점수를 입력 할 수 있는 변수선언
...
//		
		...
		String name2 = "";  //문자열타입을 생성해서 빈 공백을 입력
		int kor2 = 0;       //국어점수를 입력 할 수 있는 변수선언
		int eng2 = 0;
		int math2 = 0;
		int total2 = 0; //합계점수를 입력 할 수 있는 변수선언
